...
def test_benchmark
  ...
  get = [
      ...
      '/v1/organizations/33/market/products/43/variants',
  ...
  post = [
      '/v1/organizations/45/vacancies/34/replies',
  ...
  10000.times do
    ...
    get.each do |path|
      Endive::Router.find_route 'get', path
    end


    post.each do |path|
      Endive::Router.find_route 'post', path
    end

    put.each do |path|
      Endive::Router.find_route 'put', path
    end

    delete.each do |path|
      Endive::Router.find_route 'delete', path
    end
  ...
  p "elapsed time = #{end_time - start_time}"
